    ...
    def get_user_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(Anketa(id=str(id), firstname=firstname, lastname=lastname, address=address, home_tel=home,
                                   mobile_tel=mobile, work_tel=work, email=email, email2=email2, email3=email3))
        finally:
            cursor.close()
        return list
